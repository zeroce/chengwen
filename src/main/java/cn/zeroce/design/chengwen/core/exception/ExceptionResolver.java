...
import cn.zeroce.design.chengwen.utils.UrlUtils;
...
/**
 * 一异常处理 对于业务异常：返回头 Http 状态码一律使用500，避免浏览器缓存，在响应 Result 中指明异常的状态码 code
 *
 * @author: zeroce
 * @date 20.3.22 15:57
 */
...
public class ExceptionResolver {
    ...
    public ResultUtil validatorException(ConstraintViolationException e) {
        final String msg =
    ...
    public ResultUtil serviceException(final ServiceException e) {
    ...
    public ResultUtil resourcesException(final Throwable e) {
    ...
    public ResultUtil databaseException(final Throwable e) {
    ...
    public ResultUtil authException(final Throwable e) {
    ...
    public ResultUtil accountException(final Throwable e) {
    ...
    public ResultUtil apiNotFoundException(final Throwable e, final HttpServletRequest request) {
    ...
    public ResultUtil globalException(final HttpServletRequest request, final Throwable e) {
