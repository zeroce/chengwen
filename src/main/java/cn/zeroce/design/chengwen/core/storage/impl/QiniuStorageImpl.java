...
public class QiniuStorageImpl implements Storage {
    private final Log logger = LogFactory.getLog(QiniuStorageImpl.class);
    @Autowired
    ...
    public void generateDownloadUrl() {
        SysStorage sysStorage = this.sysStorageMapper.selectByPrimaryKey(1);
        String publicUrl = this.qiniuProperties.getPath() + "/" + sysStorage.getsKey();
        System.out.println("///////////////////////////////////////////////////////////////////");
